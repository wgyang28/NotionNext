...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '杨文根', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我善养吾浩然之气', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.wgyang.cn', // 网站地址
